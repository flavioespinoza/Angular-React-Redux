...
class OpenOrderMarker extends Component {
  ...
  render () {
    ...
    const __open_orders = __openOrders.map(function (__obj) {
      ...
      let text = utils.__toFixed(__obj.amount, null, 2, 5) + '  @  ' + utils.__toFixed(__obj.price, null, 2, 5)
      ...
      if (__obj.filled > 0) {
        opacity = 1
        // lineOpacity = 1
        text = utils.__toFixed(__obj.filled, null, 2, 5) + ' / ' + utils.__toFixed(__obj.amount, null, 2, 5)
      }
